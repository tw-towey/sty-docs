...
![在这里插入图片描述](./images/10a899e0648f41e4a1a2cd091c4b503c.png)
...
![在这里插入图片描述](./images/1e539d9cf1be42218a4b27a659908b54.png)  
基本上 vi/vim 共分为三种模式，分别是一般模式，编辑模式和命令模式。  
![在这里插入图片描述](./images/e33ebfd4bbb445bd9b1c630cde96a543.png)
...
![在这里插入图片描述](./images/b0579cfde19d470781b509c494d02fea.png)  
VMware管理了3个特殊的虚拟交换机：VMnet0（用于桥接模式），VMnet8（用于NAT模式），VMnet1（用于仅主机模式）。  
![在这里插入图片描述](./images/4cf85bd57b944b6f9478ecf8999cc3a8.png)  
...
![在这里插入图片描述](./images/59868aa2fe134a97930c9fb9c061efa6.png)  
...
![在这里插入图片描述](./images/ea02a23281b348199e1db08aa66f8e21.png)  
...
![在这里插入图片描述](./images/6d8985b634a34302803d65e8c957e0ed.png)  
...
![在这里插入图片描述](./images/c974d6617fe743b1ae6d9f4ab63a8212.png)
...
![在这里插入图片描述](./images/1529d21b3a1341ee90f283006a9c5776.png)  
...
Dos窗口登录  
![在这里插入图片描述](./images/5d1d43f781264227af27b117ff7d847b.png)  
...
❄️**CentOS7 的运行级别简化为：**
    ...
    ☃️**multi-user.target** 等价于原运行级别3，多用户有网，无图形界面）
    
    ⛄️**graphical.target** 等价于原运行级别5，多用户有网，有图形界面
...
![在这里插入图片描述](./images/753075efdfbe4549adb3b353523c08b8.png)  
...
![在这里插入图片描述](./images/c8e7c5c0c9f340428d66c3646894fa29.png)  
...
![在这里插入图片描述](./images/cb3b2acfadf54b23bf6c35055fe45a58.png)  
📎 只有文件所有者和超级用户可以修改文件或目录的权限。可以使用绝对模式（八进制数字模式），符号模式指定文件的权限。  
![在这里插入图片描述](./images/1790487a98b34ebfa1d572a102ff69b2.png)
