...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/9d7f56b7e6034251a9b0651786ad2513.png)  
当一个事务想对这条记录做改动时，首先会看看内存中有没有与这条记录关联的 锁结构 ，当没有的时候  
就会在内存中生成一个 锁结构 与之关联。比如，事务 T1 要对这条记录做改动，就需要生成一个 锁结构  
与之关联：  
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/a337af5f66304572b05f9e2e5b3d6ced.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5YeG5Zu-54G15aWW5b6X5Li7,size_19,color_FFFFFF,t_70,g_se,x_16)  
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/b021e72abcf74a7f972c22509f3b1e16.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5YeG5Zu-54G15aWW5b6X5Li7,size_18,color_FFFFFF,t_70,g_se,x_16)
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/81551082aad346d2899c80f4b444bf6c.png)  
**小结几种说法:**
...
锁的分类图，如下  
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/edd703c4cea24e79b26c0717a5faf433.png)
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/a710ccacf7e249458f16413ac74a0482.png)![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/6cf1363bb22b4aeaa4edc40cb973075e.png)  
步骤6∶加写锁  
为mylock表加write锁，观察阻塞的情况，流程如下:  
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/1624b84e36f342cb877728fbd8100f23.png)  
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/9e173d5ec8fb4f69bf3a02e0fd6c37f9.png)  
**总结:**  
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/fae293b19ead46e0b8fa7b0b0b1d480e.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5YeG5Zu-54G15aWW5b6X5Li7,size_17,color_FFFFFF,t_70,g_se,x_16)
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/57d1c86142b44da19acf02814fe77846.png)  
举例如下：  
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/da768f6b4bbf48dd8e7424d3e4761de8.png)  
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/feba072306ec40e3bc4da518905a99ec.png)  
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/91162568ae164c2a9e7ba0d92aa5b761.png)
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/4947a46d3a8447a1ab7f6ab484ced2d7.png)  
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/254017c6c51b48e793fc1edf67b8ba77.png)  
比如，现在T1为id值为8的记录加了一个gap锁，然后T2和T3分别想向student表中插入id值分别为4、5的两条记录，所以现在为id值为8的记录加的锁的示意图就如下所示:  
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/da25db4fde9242868c896e02b7c3b864.png)  
...
把乐观锁和悲观锁总结如下图所示  
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/0d5921e76c0b49718272a209cbadc3b9.png)
...
**举例一：**  
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/03b83a84c5bc4077b81b4996d0c5146f.png)  
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/c8bd60061a1149b8b14592c845fc7bb6.png)

基于这两个信息，可以绘制wait-for graph 等待图)  
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/46cb7286faa847f894d5cf0200690366.png)
...
InnoDB存储引擎中的锁结构如下:  
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/61313f335c9344f59741df23516d9c5a.png)
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/edde8f2ea1624b65898fecd5c86d0ecb.png)  
...
is\_waiting 属性呢？基于内存空间的节省，所以把 is\_waiting 属性放到了 type\_mode 这个32  
位的数字中：
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/18c71753fa3145bb92db9b667ad9bf2b.png)  
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/04a2e1950dda4e7d81a49559b65e8a63.png)  
...
下图为这个表的索引id的示意图。  
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/b22e0467814f4e5783286f6a7cfd2b00.png)
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/9778f998572344c39008ba4882154778.png)  
