...
![请添加图片描述](http://p4ui.toweydoc.tech:20080/images/stydocs/e4ad95e40a7641a4b9029782d7c9595e.png)  
从结果可以看出，索引仍然是默认的升序。  
在MySQL 8.0版本中查看数据表ts1的结构，结果如下：  
![请添加图片描述](http://p4ui.toweydoc.tech:20080/images/stydocs/f4fc2911f34641deaa3efc62f6b3a296.png)  
...
![请添加图片描述](http://p4ui.toweydoc.tech:20080/images/stydocs/cf2ed982b4744d36abd311ffe3d0cd90.png)  
...
我们知道，通过idx\_name\_birthday\_phone\_number 索引就可以对 name 列进行快速搜索，再创建一个专门针对 name 列的索引就算是一个 冗余索引 ，维护这个索引只会增加维护的成本，并不会对搜索有什么好处。  
② 重复索引  
