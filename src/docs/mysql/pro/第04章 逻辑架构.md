...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/2c194340ee30401f9f5b445d19d05d64.png)  
下面具体展开看一下（数字标号展示了5.7查询的顺序）：  
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/e280506d2cc14b579f9a08563cd285a5.png)  
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/fe6dddee4d584074beb6f6a600ca8cc5.png)
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/3b89e93578c041dcbf32e2364e4c6c5e.png)  
简化为三层结构：
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/90ed3fd78e5b467cbfdc30ceff60f465.png)
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/30730920ca9c45219148b16ba488996e.png)  
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/cb9b433a93fa40bf87931d283ca924f4.png)  
下面是SQL词法分析的过程步骤：  
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/2558289528d24f6bb8596f512c207579.png)  
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/c83ade87ae1e4a09ad968a5895d24f2c.png)  
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/0a8fbd474cf74473b48e5c72d3131082.png)  
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/50819b8511ef46fe93766092aecd583e.png)  
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/f03b2bd7cb954245a2660fe9adf9cd27.png)
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/0cdc3905ca6c4cbbb73b6f3b490d07f1.png)  
**4.查看profile**  
显示执行计划，查看程序的执行步骤：
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/1979ab83daea426ebc84ba88c409ba3e.png)  
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/e64575e3f0bc4087aa608486c351ee1b.png)
...
**5.查看profiles**  
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/02ea8dd06e604015914003a9a7a500dc.png)  
**6.查看profile**  
显示执行计划，查看程序的执行步骤：
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/a1a00896514c424aa2c0dbd946cc8529.png)  
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/dbc613fd579f4d168d5c681e57a7bc6e.png)  
...
**例子：**  
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/229d0e152f3244048c1685596121093c.png)

#### 2.4 SQL语法顺序

随着Mysql版本的更新换代，其优化器也在不断的升级，优化器会分析不同执行顺序产生的性能消耗不同而动态调整执行顺序。  
需求：查询每个部门年龄高于20岁的人数且高于20岁人数不能少于2人，显示人数最多的第一名部门信息下面是经常出现的查询顺序：  
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/a2b9bdf1cfd24950b3f2d8bc0f22f326.png)

#### 2.5 Oracle中的SQL执行流程(了解)

Oracle 中采用了共享池来判断 SQL 语句是否存在缓存和执行计划，通过这一步骤我们可以知道应该采用硬解析还是软解析。  
我们先来看下 SQL 在 Oracle 中的执行过程：  
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/1f6f8991cbec4b79a627b84f2a63336c.png)  
...
Oracle的架构图：  
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/0503da2e863f4bceb4fc156b5f1609ec.png)  
**简图：**  
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/3e682debd31e42d782528ded29c407dd.png)  
小结：  
Oracle 和 MySQL 在进行 SQL 的查询上面有软件实现层面的差异。Oracle 提出了共享池的概念，通过共享池来判断是进行软解析，还是硬解析。

## 3\. 数据库缓冲池([buffer](https://so.csdn.net/so/search?q=buffer&spm=1001.2101.3001.7020) pool)
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/579790cdeeb9444485e6b7734b9c2e1f.png)  
...
缓存在数据库中的结构和作用如下图所示：  
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/7892b7692c984c9d9fb631a9e08e539e.png)  
...
![请添加图片描述](http://p6ui.toweydoc.tech:20080/images/stydocs/5680822359604aec826fd8210c26360d.png)  
