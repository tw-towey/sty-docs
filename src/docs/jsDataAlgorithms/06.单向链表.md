...
- 链表的火车结构
  ...
  ![链表的火车结构](http://p6ui.toweydoc.tech:20080/images/stydocs/image.27xtn3c52zwg.png)
...
- 链表的数据结构
  ...
  ![链表的数据结构](http://p6ui.toweydoc.tech:20080/images/stydocs/image.37j1by46a120.png)

- 给火车加上数据后的结构

  ![给火车加上数据后的结构](http://p6ui.toweydoc.tech:20080/images/stydocs/image.664djiie2t80.png)
...
- 首先让 `currentNode` 指向第一个节点。
  ...
  ![image](http://p6ui.toweydoc.tech:20080/images/stydocs/image.5iskrdf4nu40.png)

- 通过 `while` 循环使 `currentNode` 指向最后一个节点，最后通过 `currentNode.next = newNode`，让最后一个节点指向新节点 `newNode`。

  ![image](http://p6ui.toweydoc.tech:20080/images/stydocs/image.4mw3bx5g80m0.png)
...
![image](http://p6ui.toweydoc.tech:20080/images/stydocs/image.6kx4qbq8e5c.png)
