...
![图片11.png](http://p4ui.toweydoc.tech:20080/images/stydocs/Cgp9HWCJIMaACsQqAAKt__fEo9U561.png)
...
![图片2.png](http://p4ui.toweydoc.tech:20080/images/stydocs/CioPOWCJINCAWTthAACzGJa966I160.png)
...
![图片3.png](http://p4ui.toweydoc.tech:20080/images/stydocs/Cgp9HWCJIN6ALcIOAAGvaaKiqtM412.png)

已知目的地 MAC 可以直接发送

那么如果网络接口不知道目的地地址呢？这个时候，地址解析协议就开始工作了。发送接口会发送一个广播查询给到交换机，交换机将查询转发给所有接口。

![图片4.png](http://p4ui.toweydoc.tech:20080/images/stydocs/CioPOWCJIOaAWL2vAAIjZo8-JVY343.png)

如果某个接口发现自己就是对方要查询的接口，则会将自己的 MAC 地址回传。接下来，会在交换机和发送接口的 ARP 表中，增加一个缓存条目。也就是说，接下来发送接口再次向 IP 地址 2.2.2.2 发送数据时，不需要再广播一次查询了。

![图片5.png](http://p4ui.toweydoc.tech:20080/images/stydocs/Cgp9HWCJIO-ASE1gAAIXUxAepRs289.png)
...
![图片66.png](http://p4ui.toweydoc.tech:20080/images/stydocs/CioPOWCJIPqACRqBAAJZJ8-Xz9M520.png)
...
![图片6.png](http://p4ui.toweydoc.tech:20080/images/stydocs/Cgp9HWCJIQWATnKCAAJiZ0IiUQw856.png)
...
![图片7.png](http://p4ui.toweydoc.tech:20080/images/stydocs/Cgp9HWCJIQ6AX2bSAAF-MBsPxPo191.png)
