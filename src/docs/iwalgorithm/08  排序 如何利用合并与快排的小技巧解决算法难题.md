...
![1.gif](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBa1D-AO_IyABbezYcjvnc676.gif)
...
![Drawing 1.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBa1EmAafFZAAEIbICXCH8196.png)
...
![2.gif](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBa1F-AdVjkAAW3LaUuQBI088.gif)
...
![Drawing 3.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBa1IiAdYjFAAD5CqCiV9s051.png)
...
![Drawing 4.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBa1KaAW4PrAACHWC33XvY027.png)
...
![Drawing 5.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBa1LSANaspAACnv4r9rY4076.png)

那么二个有序数组应该怎么办呢？不过现在非常确定的是，我们一定**会扔掉 4 个数**。那么接下来，你再思考一下在两个数组 A，B 中如何扔掉这 4 个数？

![3.gif](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBa1VSAUvT8AAW3QKZNDKo893.gif)

- **第 1 步：要扔掉 4 个数，我们需要看一下两个数组前 2 个元素**，如下图所示：
    

![Drawing 7.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBa1MyAO-hIAAC5HXxgqTU581.png)

此时，我们当然不知道 K、L、V、W 这四个数之间的关系。假设 L >= W，就需要证明：当 L >= W 的时候，\[V, W\] 都不可能是第 5 小的数，可以扔掉。

**解**：利用**反证法，假设 W 可以成为第 5 小的数**。推导过程如下：

![Drawing 8.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBa1dSAFbuyAADZMsuD8Ow586.png)
...
![Drawing 9.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBa1fOAIoAkAACiXXbxAyQ531.png)
...
![Drawing 10.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBa1fyARh_eAAChVnnqza8481.png)
...
![Drawing 11.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBa1gSARtRHAADy4Q6lRic201.png)
...
![Drawing 12.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBa1hCAQFCXAACzeuL27BA859.png)
...
![Drawing 13.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBa1hmARdhgAAE4KKhQNNk730.png)
...
![4.gif](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBa1j-ALNp1ABgNWSm15-g263.gif)
...
![Drawing 15.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBa1k6ARbllAAEScdmg-qE957.png)
...
![5.gif](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBa1nyASnSGAAVDCbYUIkI338.gif)
...
![Drawing 17.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBa1pKANA4tAACo1XkrwR8163.png)
...
![Drawing 18.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBa1v-AAIJ0AAC982gygBM237.png)

除了像插入排序一样一个一个地移动 1，还有没有更好的办法呢？

![Drawing 19.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBa1waAUggGAAC5a2hQFcY926.png)

答案是，不需要一个一个移动！因为 \[L, i) 区间里面全都是 1，只需要将 A\[L\] 与 A\[i\] 进行交换即可。

![Drawing 20.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBa1w6ACb84AAFajqHAao8089.png)
...
![Drawing 21.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBa1xeAR5k5AAE7tiU3JNs442.png)
...
![Drawing 22.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBa1yGAYzAPAAE2795PdwA120.png)
...
![Drawing 23.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBa1y6AKiDXAACdNXyT-iM446.png)
...
![Drawing 24.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBa1z6AY5MBAADdMHlfEo0699.png)

Case 1：只出现一次的数在左边，那么左区间的长度为奇数。

![Drawing 25.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBa10SAHug2AACvcZWpRb0183.png)

Case 2：只出现一次的数在中间，那么中间的数的长度为 1。直接返回 x。

![Drawing 26.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBa10yAdrcgAADb9niMdDU093.png)
...
![Drawing 27.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBa11mAYIeqAAEKqbsIKUc687.png)
...
![Drawing 28.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBa12aAJAvPAADQtdqxOSg472.png)
...
![Drawing 29.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBa126ABdszAADUJRcYiwA778.png)
...
![Drawing 30.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBa14-AfibNAACmG9lcp3w742.png)

Case 1. 第 k 小的数在左区间，此时 k < lcnt，其中 lcnt 是左区间中数的个数。

![Drawing 31.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBa15aARbkjAACsa_IopOo721.png)

Case 2. 第 k 小的数在中间，此时 lcnt <= k < lcnt + mcnt。其中 mcnt 是中间区间的数的个数。

![Drawing 32.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBa15uAKuRJAACsaFjbbdM444.png)
...
![Drawing 33.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBa16SAXU4SAAEW-ldWtII513.png)
...
![Drawing 34.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBa166AD9hdAAKp0wZR38g493.png)
