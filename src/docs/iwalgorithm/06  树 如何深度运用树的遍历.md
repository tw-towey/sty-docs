...
![1.gif](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBRtI-AItMYAAjasV3sa24039.gif)
...
![Drawing 1.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBRtKeAYSGpAACZpTIXfU0084.png)

输出: true

【**分析**】二叉搜索树的定义，**本质上就是一个前序遍历**。因此，可以利用前序遍历的思路来解决这道题。

![11.gif](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBUIueAOJfcAAdhS5BAUGo971.gif)
...
![Drawing 3.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBRtNGAeo22AACebFDJtSc681.png)
...
![Drawing 4.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBRtOmAcCa2AADXoM_tlx4996.png)
...
![Drawing 5.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBRtPWAR1otAACA-Iu2vmU954.png)
...
![3.gif](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBRtQqAeOlzAA3wDEKa3P4970.gif)
...
![Drawing 7.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBRtRmAU_NjAAEAKqKMPsY246.png)
...
![4.gif](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBRtSuAPkajAAkCntnG56c613.gif)
...
![2021319-12844.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBUI-qAV1MZAACWlNh4bls274.png)
...
![Drawing 10.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBRtUiAJEr9AAC21ET_Iqs675.png)
...
![Drawing 11.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBRtVWASUJoAAD2XJCLLgQ425.png)
...
![Drawing 12.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBRtWWAIxSJAABkVgPnF_o374.png)

b）当结点 1 删除之后，左子树的根结点为 2，需要设置 root.left 指向结点 2。如下图所示：

![Drawing 13.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBRtW2AARGtAAB29vC847A588.png)

c）当结点 1 删除之后，左子树根结点变成 2，需要设置 root.left 指向结点 2。如下图所示：

![Drawing 14.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBRtXaALQrkAAB3-_72MrY558.png)
...
![Drawing 15.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBRtYOAaCxfAABz2q7dEO8442.png)

在删除 1 之后，都需要返回 null。

b）如果被删除的结点有左子树。那么需要从**左子树中找到最大值**，然后与当前结点进行值**交换**。最后**再在左子树中删除 value**。步骤如下：

![5.gif](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBRtZiAEkBKAAanEhq-SYE408.gif)
...
![6.gif](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBRtbCAEv1OAAXuSoTT_wY014.gif)
...
![Drawing 18.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBRtcGAHdsVAAD8g3mqZEQ373.png)
...
![7.gif](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBRtc6AUcUpAAoB4AbuqCg073.gif)
...
![Drawing 20.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBRtdmAVCQTAACWpvqFKDQ011.png)
...
![Drawing 21.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBRte6AGgSSAANZYCc0W0I359.png)

如上图所示：如果满足 lmax < x 并且 x < rmin，那么可以认为这棵树是二叉搜索树。注意，**我们是先拿到了左子树与右子树的信息，然后再利用这个信息做出判断**。这样的操作符合后序遍历的要求。

【**画图**】这里我们拿一棵二叉搜索树来画图演示步骤，动图如下：

![12.gif](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBUIwGAAv3NAAp9VZSO5a4731.gif)
...
![Drawing 23.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBRtgKAIBrtAABQgHb3MVg861.png)
...
![9.gif](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBRtheAAqTpAAqrC7nn9cs642.gif)
...
![Drawing 25.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBRtiyAGHC7AACr9Dp8WWE577.png)

如果我们再深入思考一下，就会发现，后序遍历的时候有个**特点**：**想要验证**一棵树是否是二叉搜索树，后序遍历的**返回值**却是整棵树的信息。

这里画图来表示一下：

![Drawing 26.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBRtjaACs7TAABq6h1DLRQ985.png)

有点“**项庄舞剑，意在沛公**”的味道。那么我们再对后序遍历做一个小结，如下图所示：

![Drawing 27.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBRtj6AF94_AAC54hdOUJs668.png)
...
![Drawing 28.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBRtkaAE0QsAADAh6zPbnk294.png)
...
![Drawing 29.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBRtlCAbdR9AARsIH_iZJY236.png)

Case 2：根结点为 q，另外一个结点 p 在子树里，反之亦然。如下图所示：

![Drawing 30.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBRtlmAcMP0AAJsaaiXrk4163.png)

这里你可能会想，如果**左子树**找到 2 个结点怎么办？比如下图展示的情况：

![Drawing 31.png](http://p6ui.toweydoc.tech:20080/images/stydocs/Cgp9HWBRtmKADj4gAAKGC_G6FjM242.png)
...
![10.gif](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBRtm-AabKNAAto4bxyLyY509.gif)
...
![Drawing 33.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBRtoqAPZ6tAADozszBVY4858.png)

虽然我们只介绍了两个结点的后序遍历解法，但你也可以开阔思路来试一下多叉树的题目。

我们再归纳一下**后序遍历的思路**，可以**总结为 8 个字“项庄舞剑，意在沛公”**，如下图所示：

![Drawing 34.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBRtpGAUxzZAADV23ElNds459.png)
...
![Drawing 35.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBRtp2ACQ-ZAAKKPaNyzjs632.png)

除去知识的扩展，你还要学会浓缩和简化，抓住三种遍历的核心。我同样为你总结了一张思维导图：

![Drawing 36.png](http://p6ui.toweydoc.tech:20080/images/stydocs/CioPOWBRtqWAL6DXAADFeBomwio444.png)
